...
ユーザー視点の流れ順で1画面1枚として確認したい場合は `docs/ascii-user-flow-screens.md` を使う。
...
| BoardSurface                                                                    |
| - ZStack(g5 背景)                                                               |
| - content: 選択中 BoardMode                                                     |
| - overlay: topBar + bottomBar                                                   |
|                                                                                |
|                         選択中の BoardMode                                      |
|                                                                                |
...
|                                                                                |
| +------------------------------------------------------------------------------+|
| | CloseLoopCommitStatus + 操作行                                               ||
| | - 単品を記録 / 締め表を記録 / 締めゲート完了                                 ||
| | - 予約差分へ / 明日のボードへ                                               ||
| +------------------------------------------------------------------------------+|
+--------------------------------------------------------------------------------+
```
